...
object UpdateUtil {
    ...
    suspend fun checkForUpdate(context: Context = Spowlo.context): LatestRelease? {
    ...
    fun installLatestApk(context: Context = Spowlo.context) = context.apply {
        kotlin.runCatching {
            ...
            Utils.makeToast(R.string.app_update_failed.toString())
        }
    }

    suspend fun downloadApk(
        context: Context = Spowlo.context,
