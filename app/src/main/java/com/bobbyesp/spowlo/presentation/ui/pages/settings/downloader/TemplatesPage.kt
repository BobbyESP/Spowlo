...
@Composable
fun TemplatesPage(onBackPressed: () -> Unit) {
    ...
    var selectedTemplateIndex by remember {
        mutableStateOf(PreferencesUtil.getInt(TEMPLATE_INDEX, 0))
    }
            ...
            itemsIndexed(templates) { index, commandTemplate ->
                TemplateItem(
                    ...
                    onClick = {
                        ...
                        PreferencesUtil.updateInt(TEMPLATE_INDEX, selectedTemplateIndex)
                    })
                {
